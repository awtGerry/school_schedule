 ...
 * This module provides filesystem operations that are not available in the standard library.
 * This includes operations like copying directories, removing directories, etc.
 * The operations are implemented in Rust and exposed to JavaScript.
 * This module is used by the `fs` module in the `@tauri-apps/api` package.
 */
