/*
   Purpose:
    This is the ChatGPT prompts module, which is responsible for managing prompts data.
    It provides the ability to synchronize prompts data from GitHub, and user-defined prompts data.
    The prompts data is stored in the cache_prompts directory.
    The prompts data is used to generate the chat prompts command list.

    TODO's:
        - [ ] Add the system information to the data.
        - [ ] Add the ability to manage the prompts data in the cells module.
        - [ ] Add the ability to manage the cells data.
*/
